...
import KisahNabiPage from "./pages/KisahNabiPage";
import DetailKisahPage from "./pages/DetailKisahPage";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/kisah" element={<KisahNabiPage />} />
        <Route path="/kisah/:namaTokoh" element={<DetailKisahPage />} />
